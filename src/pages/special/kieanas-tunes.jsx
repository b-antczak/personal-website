...
const songData = [
    ...
    },
    {
        title: 'Water Ripples',
        artist: 'Enno Aare',
        description: 'This song reminds me of when you paint. You\'ve never painted in front of me, but I imagine it\'s very graceful and elagant, just like this song. I see a meticulous woman who knows that perfection cannot be rushed. Every brush stroke is planned out, as if it was a coordinated dance between two partners, with the result always being a beautiful piece of art.',
        has_lyrics: false
    },
    {
        title: 'Somebody',
        artist: 'Sigala ft. HRVY, Nina Nesbitt',
        description: 'This song reminds me of of how far we\'ve come this year. More specifically, it reminds me of how much of a positive difference you made on my life. I\'ve become so much more confident in myself, and you\'ve given me a new purpose ... you make me feel like I\'m actually somebody.',
        has_lyrics: true,
    ...
    },
    {
        ...
        description: 'This was the first song added to this playlist, the one that started it all. Its music hits such a precise part of me that reminds me about every wonderful thing about you. I don\'t know how to explain it. To be honest, I focus more on the music than the lyrics.',
        has_lyrics: true,
    ...
    },
    {
        title: 'One With You',
        artist: 'Rick Jolt',
        description: 'This song reminds me of that moment when we\'re in your room, shut off the lights and turn on the bed lights, cuddle under the blanket and just hold each other. It\'s a similar feeling to what I expereince when I listen to "In This Moment" by Gavin Luke.',
        has_lyrics: false
    },
    {
    ...
    },
    {
        ...
        has_lyrics: true,
        stand_out: 'You take forever, but you\'re always worth waiting for.'
    }
];
class KieanasTunes extends Component {
    render() {
        return (
            <div className='pt4'>
                <div className='bg-white card-shadow br3 pv3 ph4 mv3 mh3'>
                ...
                <div className='bg-white card-shadow br3 pv3 ph4 mv5 mh3'>
                <Carousel
                    infiniteLoop
                    useKeyboardArrows
                    showStatus={false}
